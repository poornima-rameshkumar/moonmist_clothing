                                    ...
                                    <div className="item flex lg:gap-10 gap-6">
                                        ...
                                        <div className='w-1/2'>
                                            ...
                                            <div className="flex items-center sm:gap-4 gap-2 mt-2">
                                                ...
                                                <Link href={'https://www.instagram.com/moonmistclothing?igsh=dHVwNTlybTIzZDhw'} target='_blank' className="item bg-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-black hover:text-white duration-300">
