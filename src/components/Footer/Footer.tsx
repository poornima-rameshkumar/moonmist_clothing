                    ...
                    <div className="container">
                            ...
                            <div className="right-content flex flex-wrap gap-y-8 basis-3/4 max-lg:basis-full">
                                <div className="list-nav flex justify-between basis-2/3 max-md:basis-full gap-4">
                                    ...
                                    <div className="item flex flex-col basis-1/3 ">
                                        ...
                                        <Link className='caption1 has-line-before duration-300 w-fit pt-2' href={'/shop/breadcrumb1'}>Sweat T-shirts</Link>
                                ...
                                <div className="newsletter basis-1/3 pl-7 max-md:basis-full max-md:pl-0">
                                    ...
                                    <div className="list-social flex items-center gap-6 mt-4">
                                        ...
                                        <Link href={'https://www.instagram.com/moonmistclothing?igsh=dHVwNTlybTIzZDhw'} target='_blank'>
                        ...
                        <div className="footer-bottom py-3 flex items-center justify-between gap-5 max-lg:justify-center max-lg:flex-col border-t border-line">
                            <div className="left flex items-center gap-8">
                                <div className="copyright caption1 text-secondary">©2023 Moonmist. All Rights Reserved.</div>
