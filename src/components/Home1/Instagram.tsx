            ...
            <div className="instagram-block md:pt-20 pt-10">
                <div className="container">
                    <div className="heading">
                        <div className="heading3 text-center">Moonmist On Instagram</div>
                    ...
                    <div className="list-instagram md:mt-10 mt-6">
                        ...
                        >
                            <SwiperSlide>
                                <Link href={'https://www.instagram.com/moonmistclothing?igsh=dHVwNTlybTIzZDhw'} target='_blank' className="item relative block rounded-[32px] overflow-hidden">
                                    <Image
