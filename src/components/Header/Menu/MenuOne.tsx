                    ...
                    <div className="header-main flex justify-between h-full">
                        ...
                        <div className="left flex items-center gap-16">
                            <Link href={'/'} className='flex items-center max-lg:absolute max-lg:left-1/2 max-lg:-translate-x-1/2'>
                                <div className="heading4 logo">
                                    <img className="logo-img"  src="/images/logo/site logo mbl-01.png" alt="moonmist-logo"></img>
                                </div>
                            </Link>
                                 ...
                                 >
                                                        ...
                                                        <div className="nav-item">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    ...
                                                                    >
                                                                        Starting From 70% Off
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div
                                                                        onClick={() => handleTypeClick('oversized t-shirts')}
                                                                        className={`link text-secondary duration-300 cursor-pointer`}
                                                                    >
                                                                        Oversize T-shirts
                                                                    </div>
                                                                ...
                                                                <li>
                                                                    <div
                                                                        onClick={() => handleTypeClick('sweat T-shirt')}
                                                                        className={`link text-secondary duration-300 cursor-pointer`}
                                                                    >
                                                                        Sweat T-shirts
                                                                    </div>
                                    ...
                                    <li className='h-full'>
                                        <Link
                                            ...
                                            className={`text-button-uppercase duration-300 h-full flex items-center justify-center ${pathname === '/shop/filter-canvas' ? 'active' : ''}`}
                                        >
                                            Shop
                                        </Link>
                                    </li>
                    ...
                    <div className="container h-full">
                        <div className="menu-main h-full overflow-hidden">
                            <div className="heading py-2 relative flex items-center justify-center">
                                ...
                                <Link href={'/'} className='logo text-3xl font-semibold text-center'>Moonmist</Link>
                            </div>
